  ...
  return (
    <header className="   flex justify-center z-50">
      <nav className="px-3  sm:px-[2rem] bg-[rgba(243,243,242)] md:px-[5rem] top-0 max-w-[1250px] py-3 flex justify-between fixed w-full h-20 items-center ">
        ...
        <ul
          className={`flex flex-col md:flex-row nav-ul z-[999] gap-20 md:py-0 py-14 md:gap-10 justify-center items-center absolute md:relative md:left-0 md:h-0  ${
            showNav
        ...
        >
          ...
          <li>
            <Link to={"/skills"}>Skill/Tools</Link>
          </li>
        </ul>
